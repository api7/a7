...
func fetchAll(client *api.Client, ggID, label string) ([]api.ConsumerGroup, error) {
	page := 1
	pageSize := 100
	var all []api.ConsumerGroup
...
func stripTimestamps(items []api.ConsumerGroup) []map[string]interface{} {
