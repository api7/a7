...
func fetchAll(client *api.Client, ggID, label string) ([]api.GlobalRule, error) {
	page := 1
	pageSize := 100
	var all []api.GlobalRule
...
func stripTimestamps(items []api.GlobalRule) []map[string]interface{} {
