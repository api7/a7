...
func TestGetPluginConfig_Table(t *testing.T) {
	ios, _, out, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodGet, "/apisix/admin/plugin_configs/pc1", httpmock.JSONResponse(`{"id":"pc1","desc":"auth","plugins":{"key-auth":{},"cors":{}}}`))
	...
	output := out.String()
	for _, expect := range []string{"FIELD", "VALUE", "id", "pc1", "desc", "auth", "plugins", "2"} {
...
func TestGetPluginConfig_JSON(t *testing.T) {
	ios, _, out, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodGet, "/apisix/admin/plugin_configs/pc1", httpmock.JSONResponse(`{"id":"pc1","desc":"auth"}`))
...
func TestGetPluginConfig_MissingGatewayGroup(t *testing.T) {
...
func TestGetPluginConfig_APIError(t *testing.T) {
	ios, _, _, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodGet, "/apisix/admin/plugin_configs/pc1", httpmock.StringResponse(http.StatusInternalServerError, `{"message":"boom"}`))
