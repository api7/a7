...
func TestUpdatePluginConfig_Success(t *testing.T) {
	ios, _, out, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodPut, "/apisix/admin/plugin_configs/pc1", httpmock.JSONResponse(`{"id":"pc1","desc":"auth2","plugins":{"cors":{}}}`))
...
func TestUpdatePluginConfig_ValidationError(t *testing.T) {
...
func TestUpdatePluginConfig_MissingGatewayGroup(t *testing.T) {
	ios, _, _, _ := iostreams.Test()
	err := actionRun(&Options{
		IO:          ios,
		Client:      func() (*http.Client, error) { return (&httpmock.Registry{}).GetClient(), nil },
...
func TestUpdatePluginConfig_APIError(t *testing.T) {
	ios, _, _, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodPut, "/apisix/admin/plugin_configs/pc1", httpmock.StringResponse(http.StatusInternalServerError, `{"message":"boom"}`))
