...
func fetchAll(client *api.Client, ggID, label string) ([]api.PluginConfig, error) {
	page := 1
	pageSize := 100
	var all []api.PluginConfig
...
func stripTimestamps(items []api.PluginConfig) []map[string]interface{} {
