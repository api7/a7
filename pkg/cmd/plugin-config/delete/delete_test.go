...
func TestDeletePluginConfig_Success(t *testing.T) {
	ios, _, out, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodDelete, "/apisix/admin/plugin_configs/pc1", httpmock.StringResponse(http.StatusOK, `{}`))
	...
	if !strings.Contains(out.String(), `Plugin config "pc1" deleted.`) {
...
func TestDeletePluginConfig_ValidationError(t *testing.T) {
...
func TestDeletePluginConfig_MissingGatewayGroup(t *testing.T) {
	ios, _, _, _ := iostreams.Test()
	err := actionRun(&Options{
		IO:     ios,
		Client: func() (*http.Client, error) { return (&httpmock.Registry{}).GetClient(), nil },
...
func TestDeletePluginConfig_APIError(t *testing.T) {
	ios, _, _, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodDelete, "/apisix/admin/plugin_configs/pc1", httpmock.StringResponse(http.StatusInternalServerError, `{"message":"boom"}`))
