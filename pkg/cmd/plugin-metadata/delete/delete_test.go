...
func TestDeletePluginMetadata(t *testing.T) {
	ios, _, out, _ := iostreams.Test()
	registry := &httpmock.Registry{}
	registry.Register(http.MethodDelete, "/apisix/admin/plugin_metadata/key-auth", httpmock.JSONResponse(`{}`))
	...
	if !strings.Contains(out.String(), `Plugin metadata for "key-auth" deleted.`) {
